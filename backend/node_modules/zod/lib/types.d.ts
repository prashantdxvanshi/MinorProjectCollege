import { errorUtil } from "../src/helpers/errorUtil";
import { ParseContext, ParseParamsNoData, ParseReturnType, SyncParseReturnType, ZodParsedType } from "../src/helpers/parseUtil";
import { partialUtil } from "../src/helpers/partialUtil";
import { util } from "../src/helpers/util";
import { MakeErrorData, StringValidation, ZodCustomIssue, ZodError } from "../src/ZodError";
...
export declare class ZodNumber extends ZodType<number, ZodNumberDef> {
    ...
    gte: (value: number, message?: errorUtil.ErrMessage | undefined) => ZodNumber;
    min: (value: number, message?: errorUtil.ErrMessage | undefined) => ZodNumber;
    gt: (value: number, message?: errorUtil.ErrMessage | undefined) => ZodNumber;
    lte: (value: number, message?: errorUtil.ErrMessage | undefined) => ZodNumber;
    max: (value: number, message?: errorUtil.ErrMessage | undefined) => ZodNumber;
    lt: (value: number, message?: errorUtil.ErrMessage | undefined) => ZodNumber;
    protected setLimit: (kind: "min" | "max", value: number, inclusive: boolean, message?: string | undefined) => ZodNumber;
...
export declare class ZodArray<T extends ZodTypeAny, Cardinality extends ArrayCardinality = "many"> extends ZodType<arrayOutputType<T, Cardinality>, ZodArrayDef<T>, Cardinality extends "atleastone" ? [T["_input"], ...T["_input"][]] : T["_input"][]> {
    _parse(ctx: ParseContext, data: any, parsedType: ZodParsedType): ParseReturnType<arrayOutputType<T, Cardinality>>;
    get element(): T;
    ...
    static create: <T_1 extends ZodTypeAny>(schema: T_1) => ZodArray<T_1, "many">;
}
