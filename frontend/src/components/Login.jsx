...
const Login = ({ setLoggedin }) => {
  ...
  return (
   ...
   <div className="shadow-input mx-auto w-full max-w-md rounded-none  bg-gradient-to-b from-blue-600 via-neutral-50 p-4 md:rounded-2xl md:p-8 dark:bg-black">
      <h2 className="text-xl font-bold text-neutral-800 dark:text-neutral-200">
        BUY $ SELL SHOP
      </h2>
      <p className="mt-2 max-w-sm text-sm text-neutral-800 dark:text-neutral-300">
        Please Login Yourself if you have signed up
      </p>
      <form className="my-8" onSubmit={handleSubmit}>
        ...
        <div className="flex flex-col space-y-4">
          ...
          <div>Create account? <a href="/Signup" className="text-blue-700 underline cursor-pointer">Sign up</a></div>
