          ...
          <div className="flex justify-between  mt-2 w-full ">
            <div className="flex w-full mr-25 border-2 rounded shadow-2xl p-4">
              ...
              <div className="w-full ">
                <input
                  placeholder="search your product title here"
                  type="text"
                  name="search"
      ...
      <div className="p-6 bg-gradient-to-r from-blue-500 via-indigo-50 min-h-screen">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {courses
            ...
            .map((course) => (
              ...
              >
                ...
                />
                <div className="p-4">
                  <h2 className="text-xl font-semibold mb-2 h-12">
                    {course.title}
                  </h2>
          ...
          <button
            ...
            className="bg-white text-black  hover:bg-black hover:text-white h-10 w-25 rounded-4xl"
          >
            +Add more
          </button>
        </div>
